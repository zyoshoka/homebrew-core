class Dmgbuild < Formula
  ...
  url "https://files.pythonhosted.org/packages/a9/ce/ac6988d0608c34193502d8069b1277ed849cd7681ea73a994bc715347a42/dmgbuild-1.6.2.tar.gz"
  ...
  test do
    system bin/"dmgbuild", "Test", testpath/"Test.dmg"
    assert_predicate testpath/"Test.dmg", :exist?
  end
end
